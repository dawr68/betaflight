...
#define BOARD_NAME        AOCODAF405MINI
...
#define MOTOR1_PIN           PA15 //M5
#define MOTOR2_PIN           PB3  //M6
#define MOTOR3_PIN           PB6  //M7
#define MOTOR4_PIN           PB7  //M8
